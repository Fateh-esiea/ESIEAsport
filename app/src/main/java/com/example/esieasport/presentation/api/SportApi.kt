...
import com.example.esieasport.presentation.api.MuscleListResponse as MuscleListResponse1

interface SportApi {
  @GET("exercisecategory")
  fun getMuscleList(): Call<MuscleListResponse1>
...
@GET("exercise")  //{category}?format=json
fun getMuscleDetail(@Query("category") category: String): Call<MuscleDetailResponse>  //@Path("category") id: String
}
